const starterItems = [
  {
    id: 1, name: "튀김", title: "바삭바삭 츤데레 아가씨", category: "fried", // 분식집 카테고리 적용
    ...
    script: {
      start: {
        ...
        choices: [
          { text: "오늘따라 유난히 더 바삭하고 예쁜데?", next: "stage2", score: 20 },
      ...
      stage3: {
        ...
        choices: [
          { text: "당연히 평생 책임져야지, 바보야.", next: "stage_ex1", score: 20 },
          { text: "그냥 떡볶이 국물이나 찍어 먹으려고.", next: "stage_ex1", score: -15 }
        ]
      },
      stage_ex1: {
        speaker: "튀김", expression: "☔ 우울",
        text: "[4장: 눅눅해진 비 오는 날]\n하아... 오늘 비가 오네... 나 튀김옷 눅눅해지는 거 제일 싫어하는데... 우산도 없고 최악이야.",
        choices: [
          { text: "내 우산 속으로 들어와. 바삭하게 지켜줄게.", next: "stage_ex2", score: 20 },
          { text: "그럼 비 맞고 뛰어가든가. 어쩔 수 없지.", next: "stage_ex2", score: -10 }
        ]
      },
      stage_ex2: {
        speaker: "튀김", expression: "🥺 진심",
        text: "[5장: 솔직한 진심]\n너, 너... 자꾸 사람 설레게 할래? 나도 이젠 내 마음 숨기기 힘들단 말이야... 더 이상 까칠하게 구는 것도 한계라고...",
        choices: [
          { text: "이제 까칠한 튀김옷은 벗고 내게 진심을 보여줘.", next: "check1", score: 20 },
          { text: "그럼 숨기지 말고 간장이나 더 가져와 봐.", next: "check1", score: -20 }
        ]
      },
      check1: {
        speaker: "튀김", expression: "🔮 심판",
        text: "정말 겉만 번지르르한 말인지, 아니면 내 바삭한 진심을 알아채 준 건지... 확인해 보겠어.",
        isCheck: true, checkAttr: "score", threshold: 80,
  ...
  {
    id: 2, name: "떡볶이", title: "불타오르는 열혈 체육부장", category: "main",
    ...
    script: {
      start: {
        ...
        choices: [
          { text: "너랑 뛰는 거라면 100바퀴도 좋지! 가자!", next: "stage2", score: 20 },
      ...
      stage3: {
        ...
        choices: [
          { text: "네 인생의 영원한 팀메이트가 되고 싶어.", next: "stage_ex1", score: 20 },
          { text: "그냥 운동 친구로서 장난친 건데?", next: "stage_ex1", score: -15 }
        ]
      },
      stage_ex1: {
        speaker: "떡볶이", expression: "💦 휴식",
        text: "[4장: 하프타임]\n하아... 너무 뛰었나? 목마르네. 근데 참 신기하다. 네가 챙겨주는 물이 세상에서 제일 시원하고 달콤한 거 알아?",
        choices: [
          { text: "여기 물! 땀 닦아줄 테니까 이리 와.", next: "stage_ex2", score: 20 },
          { text: "흘린 땀 냄새 좀 나는데, 조금만 떨어져.", next: "stage_ex2", score: -10 }
        ]
      },
      stage_ex2: {
        speaker: "떡볶이", expression: "🎯 결심",
        text: "[5장: 후반전 돌입]\n자, 이제 장난은 끝이야. 후반전엔 내 진짜 마음을 향해 풀 악셀 밟을 테니까 각오해! 내 마음 받아줄 거지?",
        choices: [
          { text: "좋아, 나도 전속력으로 널 향해 뛸게!", next: "check1", score: 20 },
          { text: "난 기권할래. 체력 딸려서 못 뛰겠어.", next: "check1", score: -20 }
        ]
      },
      check1: {
  ...
  },
  {
    ...
    script: {
      ...
      stage2: {
        ...
        choices: [
          { text: "조금 더 저어드릴게요. 완전히 달콤해질 때까지.", next: "stage3", score: 20 },
      ...
      stage3: {
        ...
        choices: [
          { text: "제 앞에서만은 솔직하고 달콤한 선배여도 돼요.", next: "stage_ex1", score: 20 },
          { text: "선배의 완벽한 쿨뷰티 모습이 깨지니 깨네요.", next: "stage_ex1", score: -15 }
        ]
      },
      stage_ex1: {
        speaker: "복숭아 아이스티", expression: "🫠 융해",
        text: "[4장: 녹아내리는 얼음]\n당신 앞에서는... 얼음처럼 차가운 학생회장 역할도 유지하기가 힘드네요. 너무 따뜻하게 다가오셔서 무장해제 될 것 같아요.",
        choices: [
          { text: "제 품에서 완전히 사르르 녹아내려도 괜찮아요.", next: "stage_ex2", score: 20 },
          { text: "에어컨 좀 더 빵빵하게 틀까요? 덥네요.", next: "stage_ex2", score: -10 }
        ]
      },
      stage_ex2: {
        speaker: "복숭아 아이스티", expression: "🥰 달콤",
        text: "[5장: 달콤한 항복]\n이제 도도한 척하는 건 포기할게요. 제 마음속 가라앉은 진심, 전부 당신에게 맡겨도 될까요?",
        choices: [
          { text: "영원히 변치 않는 달콤함을 약속할게요.", next: "check1", score: 20 },
          { text: "학생회 일이나 똑바로 하세요, 선배.", next: "check1", score: -20 }
        ]
      },
      check1: {
  ...
  },
  {
    ...
    script: {
      start: {
        ...
        choices: [
          { text: "오늘 유난히 더 눈부시고 상큼하네, 우리 갸루 공주님!", next: "stage2", score: 20 },
      ...
      stage3: {
        ...
        choices: [
          { text: "당연하지! 세상에서 제일 예쁜 여친으로 만들어 줄게.", next: "stage_ex1", score: 20 },
          { text: "그냥 인싸들 맞춤용 립서비스였어.", next: "stage_ex1", score: -20 }
        ]
      },
      stage_ex1: {
        speaker: "복숭아 슬러시", expression: "😵 어질",
        text: "[4장: 머리가 띵해]\n앗, 차가워! 나 오빠 생각하면서 슬러시 너무 급하게 마셨나 봐, 머리가 띵해... 빙글빙글 돈다~",
        choices: [
          { text: "천천히 마셔, 내가 따뜻하게 안아줄 테니까.", next: "stage_ex2", score: 20 },
          { text: "미련하게 그걸 원샷하냐? 바보야.", next: "stage_ex2", score: -10 }
        ]
      },
      stage_ex2: {
        speaker: "복숭아 슬러시", expression: "🥺 애교",
        text: "[5장: 녹기 전에 잡아줘]\n오빠, 나 완전히 물처럼 녹아버리기 전에 꽉 잡아줘야 해! 나 진짜 오빠한테 푹 빠졌단 말이야!",
        choices: [
          { text: "평생 내 품에서 상큼하게 지켜줄게!", next: "check1", score: 20 },
          { text: "녹으면 그냥 단물이잖아? 별로네.", next: "check1", score: -20 }
        ]
      },
      check1: {
  ...
  {
    id: 5, name: "주먹밥", title: "털털한 톰보이 골목대장", category: "main",
    ...
    script: {
      ...
      stage2: {
        ...
        choices: [
          { text: "부끄러워하는 모습 보니까 더 여자 같고 예쁜걸.", next: "stage3", score: 20 },
      ...
      stage3: {
        ...
        choices: [
          { text: "이젠 친구 안 해. 내 당당한 여친이 되어줘.", next: "stage_ex1", score: 20 },
          { text: "미안, 역시 넌 털털한 남동생 같은 게 편해.", next: "stage_ex1", score: -20 }
        ]
      },
      stage_ex1: {
        speaker: "주먹밥", expression: "🍙 결속",
        text: "[4장: 단단하게 뭉친 마음]\n헤헤... 주먹밥처럼 널 향한 내 마음도, 이젠 절대 부서지지 않게 꽉꽉 단단하게 뭉쳐졌어.",
        choices: [
          { text: "내 마음도 이미 너와 하나로 뭉쳐졌는걸.", next: "stage_ex2", score: 20 },
          { text: "밥알 다 튀니까 말하면서 먹지 마.", next: "stage_ex2", score: -10 }
        ]
      },
      stage_ex2: {
        speaker: "주먹밥", expression: "💕 용기",
        text: "[5장: 용기 낸 한 걸음]\n맨날 털털한 척, 강한 척했지만... 이젠 네 옆에 가장 예쁘고 든든한 여자로 서고 싶어. 내 손, 잡아줄래?",
        choices: [
          { text: "넌 처음부터 내게 가장 아름다운 여자였어.", next: "check1", score: 20 },
          { text: "갑자기 여자 행세하니까 징그럽고 어색하다.", next: "check1", score: -20 }
        ]
      },
      check1: {
  ...
  {
    id: 6, name: "어묵", title: "늘 구석에 숨은 소심한 소녀", category: "soup",
    ...
    script: {
      start: {
        ...
        choices: [
          { text: "아냐, 그 꼬불거리는 모습이 얼마나 귀엽고 보호본능을 자극하는데.", next: "stage2", score: 20 },
      ...
      stage3: {
        ...
        choices: [
          { text: "가지 않아. 영원히 네 온기에 기대어 쉴게.", next: "stage_ex1", score: 20 },
          { text: "미안, 역시 꼬인 마음을 받아주긴 버겁네.", next: "stage_ex1", score: -20 }
        ]
      },
      stage_ex1: {
        speaker: "어묵", expression: "🍢 해방",
        text: "[4장: 꼬치에서 빼낸 마음]\n세상을 원망하며 꼬불꼬불 비비 꼬여서 상처만 받던 제 마음이, 당신 덕분에 올곧게 펴졌어요. 정말 고마워요...",
        choices: [
          { text: "활짝 펴진 네 마음, 내가 소중하게 간직할게.", next: "stage_ex2", score: 20 },
          { text: "꼬불이가 씹는 식감이 더 좋은데 아쉽네.", next: "stage_ex2", score: -10 }
        ]
      },
      stage_ex2: {
        speaker: "어묵", expression: "💕 결심",
        text: "[5장: 온기를 전하며]\n당신이 제게 주신 따뜻한 다정함... 이제는 제가 평생 따끈하게 지켜드리고 싶어요. 부족한 저라도, 받아주실래요?",
        choices: [
          { text: "영원히 너의 따뜻한 품 안에서 쉴게.", next: "check1", score: 20 },
          { text: "난 매운 국물이 더 취향이라 밍밍해서 별로.", next: "check1", score: -20 }
        ]
      },
      check1: {
        speaker: "어묵", expression: "🫣 수줍",
      ...
      stage4_fail: {
        ...
        text: "[배드 엔딩: 다시 차가운 구석으로]\n흐윽... 역시 전 혼자가 어울려요... 기대했던 제가 바보였죠. 다시 차가운 국물 속으로 숨을게요. 절 잊어주세요...",
        choices: []
      }
    }
  },
  {
    id: 7, name: "순대", title: "모성애 가득한 포근한 마망", category: "soondae",
    ...
    script: {
      ...
      stage2: {
        ...
        choices: [
          { text: "더 이상 아이가 아니에요. 한 명의 여자로 사랑할게요.", next: "stage3", score: 20 },
      ...
      stage3: {
        ...
        choices: [
          { text: "남은 평생을 마망이 아닌 제 아내로 챙겨드릴게요.", next: "stage_ex1", score: 20 },
          { text: "역시 나이 차이가 느껴져서 안 되겠어요.", next: "stage_ex1", score: -20 }
        ]
      },
      stage_ex1: {
        speaker: "순대", expression: "🪵 결속",
        text: "[4장: 당면처럼 얽힌 인연]\n후훗, 우리 인연도 이 찰당면처럼 쫀득하게 얽혀서 이젠 절대 끊어지지 않게 되어버렸네. 신기하지 않니?",
        choices: [
          { text: "얽힌 실타래처럼 평생 함께 풀어가요.", next: "stage_ex2", score: 20 },
          { text: "가위로 싹둑 잘라서 먹으면 그만인데요.", next: "stage_ex2", score: -10 }
        ]
      },
      stage_ex2: {
        speaker: "순대", expression: "💕 성숙",
        text: "[5장: 어른의 연애]\n이제 칭얼대는 아이를 달래주는 마망이 아니라... 한 명의 남자로서 내 곁에 나란히 서주겠니?",
        choices: [
          { text: "당신만의 듬직하고 영원한 반려자가 될게요.", next: "check1", score: 20 },
          { text: "전 영원히 마망의 아기로 남을래요. 응애.", next: "check1", score: -20 }
        ]
      },
      check1: {
        speaker: "순대", expression: "🔮 자애",
